...
for i,cell in enumerate(cells):
    ...
    if len(cells[i][0]) == 1:
        ...
        cells[i][0][0].save(folder_name + "/" + folder_name + str(cell[1]) + ".gif")
    else:
        cells[i][0][0].save(folder_name + "/" + folder_name + str(cell[1]) + ".gif", save_all = True, duration = 100, append_images = cells[i][0][1:])
